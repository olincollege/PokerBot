...
def load_preflop_data():
    try:
        ...
        return {
            ...
            "AKs": 0.82, "AQs": 0.78, "AJs": 0.75, "AKo": 0.75, 
            "22": 0.5, "32o": 0.2
        }
        ...
        if os.path.exists(self.save_path):
            try:
                with open(self.save_path, 'r') as f:
                    ...
                    print(f"Strategy loaded from {self.save_path}. Games played: {self.games_played}")
            except Exception as e:
...
def bot_action(self):
    ...
    valid = self.bot.get_valid_actions(betting_state, self.raise_count >= self.max_raises_per_round)
